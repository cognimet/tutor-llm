...
class TutorController extends Controller
{
    ...
    protected function streamReply(ChatSession $session, $user, string $prompt): StreamedResponse
    {
        ...
        $response = new StreamedResponse(function () use ($session, $user, $prompt, $history, $topic, $chapter, $subject) {
            ...
            // gets an answer.
            if ($full === '') {
                $full = $this->tutor->explain($user, $topic, $chapter, $subject, $history, $prompt);
                if ($full !== '') {
