...
class TutorController extends Controller
{
    ...
    protected function streamReply(ChatSession $session, $user, string $prompt, string $mode = 'teach', string $notesContext = ''): StreamedResponse
    {
        ...
        $response = new StreamedResponse(function () use ($session, $user, $prompt, $history, $summary, $topic, $chapter, $subject, $mode, $notesContext) {
            ...
            // gets an answer.
            if ($full === '') {
                $full = $this->tutor->explain($user, $topic, $chapter, $subject, $history, $prompt, $mode, $notesContext, $summary);
                if ($full !== '') {
